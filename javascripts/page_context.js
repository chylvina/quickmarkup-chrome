var __qmScreenCapturePageContext__ = {
  ...
  init: function() {
    if (!this.bodyWrapperDelegate_) {
      this.bodyWrapperDelegate_ =
          new __qmScreenCapturePageContext__.ObjectWrapDelegate(
              document.body, '^(DOCUMENT_[A-Z_]+|[A-Z_]+_NODE)$');
      document.documentElement.addEventListener(
          '__qm_check_hook_status_event__',
          __qmScreenCapturePageContext__.bind(this, this.checkHookStatus));
    }
  }
};
...
__qmScreenCapturePageContext__.ObjectWrapDelegate = function(
    originalObject, propertyNameFilter) {
  this.window_ = window;

  // The wrapper is the object we use to wrap the 'originalObject'.
  this.wrapper_ = __qmScreenCapturePageContext__.clone(originalObject);
...
__qmScreenCapturePageContext__.ObjectWrapDelegate.prototype.getWrapper =
    function() {
...
__qmScreenCapturePageContext__.ObjectWrapDelegate.prototype.hasProperty =
...
__qmScreenCapturePageContext__.ObjectWrapDelegate.prototype.watch = function(
...
__qmScreenCapturePageContext__.ObjectWrapDelegate.prototype.unwatch = function(
    propertyName, watchHandler) {
  if (!this.hasProperty(propertyName))
    return false;
  var watchers = this.watcherTable_[propertyName];
...
__qmScreenCapturePageContext__.init();
